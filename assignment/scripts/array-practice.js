...
let favoriteFoodsArray = ['pizza', 'peaches', 'ice cream', 'macaroni & cheese', 'chicken & wild rice soup'];
...
favoriteFoodsArray.push('sweet potatoes');
...
favoriteFoodsArray.unshift('tortellini');
